...
> [`safety/oxidized/pcre2`](https://tangled.org/overby.me/overby.me/tree/main/safety/oxidized/pcre2) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/oxidized-pcre2](https://tangled.org/overby.me/oxidized-pcre2) and
> [github.com/overby-me/oxidized-pcre2](https://github.com/overby-me/oxidized-pcre2). Both
...
Used by `safety/oxidized/grep` for `-P` mode. Replaces `fancy-regex`, which lacks real
